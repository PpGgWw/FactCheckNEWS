...
[
  {
    ...
    "output": {
      "진위": "**[중요 - 5단계 진위 체계 엄수]** 교차 검증 후 최종 판단은 정확히 다음 5가지 중 하나만 사용: '거짓' / '대체로 거짓' / '일부 사실' / '대체로 사실' / '사실'. **[절대 금지]** '진짜 뉴스', '가짜 뉴스', '사실입니다', '거짓입니다', '~일 가능성', '신뢰', '의심' 등 5단계 외의 표현 사용 시 시스템 오류 발생",
      "근거": "최종 판단의 근거를 나열",
...
[
  {
    ...
    "output": {
      "진위": "**[${currentStep}차 검증 - 5단계 진위 체계 필수 준수]** 재귀적 검증 후 최종 판단은 정확히 다음 중 하나만 사용: '거짓', '대체로 거짓', '일부 사실', '대체로 사실', '사실'. **[절대 금지]** '진짜 뉴스', '가짜 뉴스', '~일 가능성', '신뢰할 수 있음', '의심스러움', '확실', '불확실' 등 5단계 외 표현 절대 사용 금지",
      "근거": "최종 판단의 근거를 나열",
      "분석": "다음 구조로 가독성 높게 작성하세요:<br><br>**✨ 기사 개요**<br>기사가 다루는 핵심 내용을 1-2문장으로 간단히 정리<br><br>**📊 주요 분석 결과**<br>위 근거에서 발견된 핵심 문제점 또는 신뢰할 수 있는 요소를 항목별로 명확히 설명<br><br>**⚠️ 검증 한계**<br>(있다면) 현재 검증으로는 확인 불가능한 정보나 추가 확인이 필요한 부분을 간단히 언급<br><br>**⚖️ 종합 판단**<br>위 내용을 바탕으로 최종 신뢰도 평가와 그 이유를 2-3문장으로 명확히 정리<br><br>※ 각 섹션은 <br><br>로 구분하고, 섹션 제목은 이모지+굵은 글씨(**텍스트**)로 표시하세요",
